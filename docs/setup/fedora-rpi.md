---
title: Installing and configuring Fedora on the CM4
---
...
Fedora always has the latest version of chrony and chrony can make use of the CM4's PTP hardware support for NTP,
...
See separate [page]({%link setup/rpi-uart.md %}#fedora) for UART configuration.
