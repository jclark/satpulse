...
- [GNSS modules]({%link hardware/gnss-modules.md %}) explains about the various kinds of GNSS module you can get; a module is the main component of a GNSS receiver, and determines most of its capabilities.
