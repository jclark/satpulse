...
- `satpulsetool gps` now reports whether each command sent from the ByNav message file was accepted or rejected, with the receiver's error text. Message files select this with the new `novatel` response pattern.
