...
- `satpulsetool decode` has a new `--vendor` option, which decodes NovAtel-format packets using the named vendor's variant of the protocol: ByNav, SinoGNSS and Unicore receivers each encode ports differently and have logs of their own.
