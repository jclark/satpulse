...
**pollsim**
: Simulate the serial PPS polling loop
...
**satpulsed(8)**, **satpulsetool-gps(1)**, **satpulsetool-serial(1)**, **satpulsetool-pack(1)**, **satpulsetool-scan(1)**, **satpulsetool-sdp(1)**, **satpulsetool-syncsim(1)**, **satpulsetool-pollsim(1)**, **satpulsetool-convobs(1)**
