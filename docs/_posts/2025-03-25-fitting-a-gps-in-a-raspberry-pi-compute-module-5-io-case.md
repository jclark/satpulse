...
The [setup section]({%link setup/index.md %}) of the documentation explains how to install and configure the necessary software. The initial speed of the serial port is 38400.
