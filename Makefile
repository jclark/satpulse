...
ARCH:=$(shell uname -m)
MAN_PAGES=satpulsetool.1 satpulsetool-gps.1 satpulsetool-serial.1 satpulsetool-pack.1 satpulsetool-scan.1 satpulsetool-sdp.1 satpulsetool-syncsim.1 satpulsetool-pollsim.1 satpulsetool-convobs.1 satpulsewb.1 satpulse.toml.5 satpulsed.8
...
install: out/$(GOARCH)/satpulsed out/$(GOARCH)/satpulsetool out/$(GOARCH)/satpulsewb out/$(GOARCH)/satpulse.toml $(MAN_TARGETS) gpsmsg
	...
	install -D -m 644 out/satpulsetool-pollsim.1 /usr/local/share/man/man1/satpulsetool-pollsim.1
...
uninstall:
	...
	rm -f /usr/local/share/man/man1/satpulsetool-pollsim.1
...
$(DEB_PATTERN): $(ALL_GOARCH) $(TOMLS) $(MAN_GZ_TARGETS) gpsmsg
	...
	install -D -m 644 out/satpulsetool-pollsim.1.gz out/$*/deb/usr/share/man/man1/satpulsetool-pollsim.1.gz
