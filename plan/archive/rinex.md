...
16. Polish metadata handling and add metadata diffing.
    ...
    d) Done: switch the `convobs` golden files to RTKLIB Explorer output and
...
Deferred full RINEX observation reader work was split to
`plan/full-rinex-obs-reader.md` before this plan was archived.
