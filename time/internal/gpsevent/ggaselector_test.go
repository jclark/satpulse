...
func TestGGASelectorOriginalSuppressesSynthSameUTC(t *testing.T) {
	...
	oneSelectedGGA(t, s)
	s.GGASentence(nmeamsg.MakeGGA("GN", time.Date(2026, 6, 24, 12, 35, 19, 0, time.UTC), &[2]float64{1, 2}, 1, pu8(8), pf64(0.9)))
...
func TestGGASelectorSynthDifferentUTCForwarded(t *testing.T) {
	...
	oneSelectedGGA(t, s)
	s.GGASentence(nmeamsg.MakeGGA("GN", time.Date(2026, 6, 24, 12, 35, 20, 0, time.UTC), &[2]float64{1, 2}, 1, pu8(8), pf64(0.9)))
...
func TestGGASelectorSynthPacketValid(t *testing.T) {
	s := NewGGASelector()
	s.GGASentence(nmeamsg.MakeGGA("GN", time.Date(2026, 6, 24, 12, 35, 19, 0, time.UTC), &[2]float64{13.731826167, 100.644802333}, 1, pu8(8), pf64(1.2)))
