...
func BenchmarkReplaceIndex_Optimized(b *testing.B) {
	w := New[int64](100)
	for i := 0; i < 100; i++ {
		w.Add(int64(i))
	}
	...
	for i := 0; i < b.N; i++ {
		idx := uint8(i % 100)
		w.replaceIndex(idx, int64(i))
	}
}

func BenchmarkReplaceIndex_Naive(b *testing.B) {
	w := New[int64](100)
	for i := 0; i < 100; i++ {
		w.Add(int64(i))
	}
	...
	for i := 0; i < b.N; i++ {
		idx := uint8(i % 100)
		replaceIndexNaive(w.values, &w.indices, idx, int64(i))
	}
}

func BenchmarkReplaceIndex_Optimized_Size5(b *testing.B) {
	w := New[int64](5)
	for i := 0; i < 5; i++ {
		w.Add(int64(i))
	}
...
func BenchmarkReplaceIndex_Naive_Size5(b *testing.B) {
	w := New[int64](5)
	for i := 0; i < 5; i++ {
		w.Add(int64(i))
	}
...
func BenchmarkReplaceIndex_Optimized_Size10(b *testing.B) {
	w := New[int64](10)
	for i := 0; i < 10; i++ {
		w.Add(int64(i))
	}
...
func BenchmarkReplaceIndex_Naive_Size10(b *testing.B) {
	w := New[int64](10)
	for i := 0; i < 10; i++ {
		w.Add(int64(i))
	}
...
func BenchmarkWindow_Add_Size100(b *testing.B) {
	w := New[int64](100)
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		w.Add(int64(i))
