...
func TestParseFlags(t *testing.T) {
	for _, tc := range []struct {
		...
		{args: []string{"-g", "18", "--cpu", "3", "--priority", "40", "--outlier-ratio", "4", "-t", "150", "-j"}},
		...
		{args: []string{"-g", "18", "--outlier-ratio", "NaN"}, wantErr: "--outlier-ratio must be"},
		{args: []string{"-g", "18", "--outlier-ratio", "0.5"}, wantErr: "--outlier-ratio must be"},
