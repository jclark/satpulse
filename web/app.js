...
(() => {
  ...
  function formatTimestamp(t2, locales) {
    const match = timestampRegex.exec(t2);
    if (!match) {
      return null;
    }
    ...
    const d = /* @__PURE__ */ new Date(initial + "00Z");
    return formatDate(d, second, locales);
  }
  function formatDate(d, second, locales) {
  ...
  var DateTimeComponent = class extends k {
    constructor(props) {
      super(props);
    ...
    render() {
      return /* @__PURE__ */ o2("div", { class: "dateTime", children: [
        /* @__PURE__ */ o2("div", { class: "timeZoneName", children: this.state.timeZoneName }),
        /* @__PURE__ */ o2("div", { class: "time", children: this.state.time }),
        /* @__PURE__ */ o2("div", { class: "date", children: this.state.date })
      ] });
    }
  };
  DateTimeComponent.contextType = EventSourceContext;
