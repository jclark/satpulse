...
func TestParsePeriodicMsg(t *testing.T) {
	tests := []struct {
		...
		{
			name:    "SVINStatus",
			payload: "PQTMSVINSTATUS,1,195586000,2,,11,60,60,-1144697.5814,6090333.9142,1504169.7911,0.1703",
			want: &SVINStatus{
				TOW:     195586000,
				Valid:   2,
				Res1:    "11",
				Obs:     60,
				CfgDur:  60,
				MeanX:   opt.Make(-1144697.5814),
				MeanY:   opt.Make(6090333.9142),
				MeanZ:   opt.Make(1504169.7911),
				MeanAcc: opt.Make(0.1703),
			},
		},
		{
			name:    "NAV",
			...
			want: &NAV{
				...
				SatView:    opt.Make[decUint8](78),
				SatUsed:    opt.Make[decUint8](56),
		...
		{
			name:    "NAV pre-lock",
			payload: "PQTMNAV,1,0,1,101307.000,20260306,,,,,,0,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,",
			want: &NAV{
				TimeStatus: 0,
				TimeRef:    1,
				UTC:        "101307.000",
				Date:       "20260306",
				SolType:    opt.Make[uint8](0),
			},
		},
		{
			name:    "PPPNAV",
			payload: "PQTMPPPNAV,1,1,1,072703.000,20260415,286041000,2414,18,1,,6,,49.19484103,2.47996030,56.2874,44.6858,,,0.2254,0.3138,0.5100,,,9002,13.000,,33,33,,,,,,,0.0023,0.0149,0.1413,0.1973,,,48.19,,,",
			want: &PPPNAV{
				TimeStatus: 1,
				TimeRef:    1,
				UTC:        "072703.000",
				Date:       "20260415",
				TOW:        opt.Make[uint32](286041000),
				WN:         opt.Make[uint16](2414),
				LeapSec:    opt.Make[uint8](18),
				Datumid:    opt.Make[uint8](1),
				SolType:    opt.Make[uint8](6),
				Lat:        opt.Make(49.19484103),
				Lon:        opt.Make(2.47996030),
				Alt:        opt.Make(56.2874),
				Sep:        opt.Make(44.6858),
				LatStd:     opt.Make(0.2254),
				LonStd:     opt.Make(0.3138),
				AltStd:     opt.Make(0.5100),
				DiffID:     opt.Make[uint16](9002),
				DiffAge:    opt.Make(13.000),
				SatView:    opt.Make[decUint8](33),
				SatUsed:    opt.Make[decUint8](33),
				HVel:       opt.Make(0.0023),
				VVel:       opt.Make(0.0149),
				HVelStd:    opt.Make(0.1413),
				VVelStd:    opt.Make(0.1973),
				COG:        opt.Make(48.19),
			},
		},
		{
