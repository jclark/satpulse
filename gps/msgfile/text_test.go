...
func TestNMEAMatcher(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "PAIR ack success",
			sentText: "PAIR072,5",
			tag:      gpsreg.TagNMEA,
			data:     makeNMEA("PAIR001,072,0"),
			wantKind: AckResponse,
			wantErr:  "",
		},
		{
			...
			sentText: "PAIR072,5",
			tag:      gpsreg.TagNMEA,
			data:     makeNMEA("PAIR001,072,3"),
			wantKind: AckResponse,
			wantErr:  "command not supported",
		},
		{
			name:     "PAIR data response",
			sentText: "PAIR073",
			tag:      gpsreg.TagNMEA,
			data:     makeNMEA("PAIR073,5"),
			wantKind: OtherResponse,
		},
		{
			name:     "PAIR command ID mismatch",
			sentText: "PAIR072,5",
			tag:      gpsreg.TagNMEA,
			data:     makeNMEA("PAIR001,073,0"),
			wantKind: NotResponse,
		},
		{
			name:     "PAIR vs PQTM cross-vendor mismatch",
			sentText: "PAIR072,5",
			tag:      gpsreg.TagNMEA,
			data:     makeNMEA("PQTMCFGPPS,OK"),
			wantKind: NotResponse,
