...
func TestPosTypeQuality(t *testing.T) {
	tests := []struct {
		...
		{17, "PSRDIFF", gpsprot.FixLevelCodeCorrected, gpsprot.SolutionDim3D, gpsprot.CorrOSR.Expand(), 0, true},
		...
		{54, "INS_PSRDIFF", gpsprot.FixLevelCodeCorrected, gpsprot.SolutionDim3D, gpsprot.CorrOSR.Expand(), gpsprot.AuxSrcINS, true},
