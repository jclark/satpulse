...
func TestMsgID(t *testing.T) {
	tests := []struct {
		...
		{"bace00000a0400000a04", "MON-VER"},
		{"bace040005000a0400000e040500", "ACK-NAK"},
		{"bace04000501060700000a070501", "ACK-ACK"},
		{"bace2c0006070000000000300000081001000003f409000000000000000000000000000000000000000000000000000000003443fb10", "CFG-NAVX"},
	}
	for _, tc := range tests {
